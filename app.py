...
<style>
@media print {
    /* Oculta la barra de navegación, el menú de Streamlit y elementos decorativos */
    header, footer, [data-testid="stSidebar"], [data-testid="stHeader"], .stTabs [role="tablist"] {
        display: none !important;
    }
    /* Estilo del reporte impreso */
    .report-container {
...
tabs = st.tabs([
    ...
    "Módulo 2: Simulador de Espectros",
    "Módulo 3: Evaluación y Entregable"
])
...
with tabs[0]:
    ...
    st.info("""
    Estas constantes aparecen en las ecuaciones porque la espectroscopía es cuantitativa y cuántica. 
    Los intercambios de energía ocurren en paquetes discretos llamados cuantos.
    """)

# -----------------------------------------------------------------------------
# MÓDULO 2: SIMULADOR UNIFICADO (BASADO EN UAM)
# -----------------------------------------------------------------------------
with tabs[1]:
    st.header("Módulo 2: Simulador de Espectros de Rotación-Vibración")
...
# -----------------------------------------------------------------------------
# MÓDULO 3: EVALUACIÓN Y ENTREGABLE (MÓDULO 6 ANTERIOR)
# -----------------------------------------------------------------------------
with tabs[2]:
    st.header("Módulo 3: Evaluación y Entregable Final")
    ...
    # BOTÓN DE IMPRESIÓN EXCLUSIVO DEL REPORTE DEL ESTUDIANTE
    ...
    # Script JavaScript que dispara la ventana de impresión seleccionando solo los resultados
    st.components.v1.html(
        """
